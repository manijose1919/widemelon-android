...
void GLRenderer::PrepareCaptureFrame()
{
    ...
    {
        const int srcX0 = WideMelon::SidePad() * ScaleFactor;
        const int srcX1 = srcX0 + 256 * ScaleFactor;
        glBlitFramebuffer(srcX0, 0, srcX1, ScreenH, 0, 0, 256, 192, GL_COLOR_BUFFER_BIT, GL_NEAREST);
    }
